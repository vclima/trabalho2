...
#define IGUAL 260
#define EOL 261
#define BRILHO_MULT 262
#define BRILHO_DIV 263
#define COLCHETE 264
#define EXIT 265
#define NUMERO 266
#define SOMA 267
...
{
  "$end", "error", "$undefined", "STRING", "VAR", "IGUAL", "EOL",
  "BRILHO_MULT", "BRILHO_DIV", "COLCHETE", "EXIT", "NUMERO", "SOMA",
...
#line 35 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
      printf("Modificando o brilho de %s com um fator de %.2f\n",(yyvsp[-2].strval),(yyvsp[0].fval));
      imagem I1,I2,I3;
      imagem I = abrir_imagem((yyvsp[-2].strval));
      I=brilho_thread(I,(yyvsp[0].fval),4);
      I1=brilho_process(I,(yyvsp[0].fval),4);
      I2=brilho_h(I,(yyvsp[0].fval));
      I3=brilho_v(I,(yyvsp[0].fval));
      salvar_imagem((yyvsp[-2].strval),&I);
      liberar_imagem(&I);
    }
...
#line 46 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
      printf("Modificando o brilho de %s com um fator de %.2f\n",(yyvsp[-2].strval),1/(yyvsp[0].fval));
      imagem I = abrir_imagem((yyvsp[-2].strval));
      I=brilho_v(I,1/(yyvsp[0].fval));
      salvar_imagem((yyvsp[-2].strval),&I);
      liberar_imagem(&I);
    }
...
#line 66 "./src/imageprocessing.y" /* yacc.c:1906  */
